...
(
	...
	JonesForth contains support for i386 assembler to be embedded into FORTH words, but this
	feature has not been implemented, and the i386 support has been removed.
)
